...
class Chart extends StatelessWidget {
  ...
  List<expenseBucket> get buckets {
    return [
      expenseBucket.ofcategory(expenses, Categorys.food),
      expenseBucket.ofcategory(expenses, Categorys.leisure),
      expenseBucket.ofcategory(expenses, Categorys.travel),
      expenseBucket.ofcategory(expenses, Categorys.work),
    ];
  }
